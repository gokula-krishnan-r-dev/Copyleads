          ...
          <div className="bg-[#636D78] px-8 py-6 rounded-2xl">
            ...
            <div className="flex object-contain py-2 items-center space-x-3">
              <img
                ...
                src="/Image/PaymentIcon/visa.svg"
                alt=""
              />
              <img
                className="w-8 md:w-[43.64px]"
                src="/Image/PaymentIcon/Discover.svg"
                alt=""
              />
              <img
                className="w-8 md:w-[43.64px]"
                src="/Image/PaymentIcon/MasterCard.svg"
                alt=""
              />
              <img
                className="w-8 md:w-[43.64px]"
                src="/Image/PaymentIcon/Amex.svg"
                alt=""
              />
              <img
                className="w-8 md:w-[43.64px]"
                src="/Image/PaymentIcon/ApplePay.svg"
                alt=""
              />
              <img
                className="w-8 md:w-[43.64px]"
                src="/Image/PaymentIcon/AmazonPay.svg"
                alt=""
              />
            </div>
            <div className="py-1">
